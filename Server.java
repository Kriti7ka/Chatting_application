...
public class Server implements ActionListener {
    ...
    Server() {
        ...
        JLabel name = new JLabel("Jasleen");
        ...
        sp.setBounds(5, 75, 440, 520); // ⬅️ updated
        sp.setBorder(null);
        f.add(sp);
 ...
 public static void main(String[] args) {
    Server server = new Server(); // create instance
        ...
        while (true) {
            ...
            while (true) {
                ...
                SwingUtilities.invokeLater(() -> {
                    server.a1.add(left);
                    server.a1.add(Box.createVerticalStrut(15));
                    server.a1.revalidate();
                    server.a1.repaint();

                    server.sp.getVerticalScrollBar().setValue(server.sp.getVerticalScrollBar().getMaximum());
                });
            }
        }
    } catch (Exception e) {
